...
screen = pygame.display.set_mode((4*r,4*r))
mid_screen = (2*r,2*r)
clock = pygame.time.Clock()
perspective_index = 1.5*r
...
class Point:
  ...
  def rotate(self, R):
    ...
    self.updateDrawPosition()
  def applyMatrixRotation(matrix):
...
class Planet:
  def __init__(self, lon = 20, lat = 10, r=r, type = (1,1,0,0)):
    ...
    print(self.getOrientationMatrix())
...
while RUN:
    ...
    rX = (keys[pygame.K_RIGHT]-keys[pygame.K_LEFT])*.02
    rY = (keys[pygame.K_UP]-keys[pygame.K_DOWN])*.02
