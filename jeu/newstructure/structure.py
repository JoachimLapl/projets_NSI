        ...
        if rel_display != None:
            i.rect= Vector.add(
                ...
                *(((i.subsides.rect[0],0) if rel_display == 'horizontal' else (0, i.subsides.rect[1]),
                (i.subsides.rect[2],0) if rel_display == 'horizontal' else (0, i.subsides.rect[3])) if j != 0 else ()),
...
window = Window(
    ...
    Page(
        Box((0,0,'100vw', '4vh'),
            Button(('100vw-3.8vh','.2vh', '3.6vh', '3.6vh'), lambda **i:Page.open(0), background='Assets/Icons/cross.png'),
            background=0xffffff),
